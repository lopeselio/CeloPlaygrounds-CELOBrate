...
import { abi } from "../contracts/forumAbi";
import './Navbar.css'
// import { CeloProvider } from '@celo-tools/celo-ethers-wrapper'


const CONTRACT_ADDRESS = "0x72fE004d63ce4A48B18959A04AcF793276026C80";
...
export default function Forum( props ) {  
    ...
    return (
        <Container className="forum" style={{ padding:"0px", border:"1px solid grey" }}>
                        ...
                        <div className="SendMessage"  style={{ borderTop:"2px solid black", position:"relative", bottom:"0px", padding:"10px 45px 0 45px", margin:"0 95px 0 0", width:"97%" }}>
                            <Form onSubmit={ (e) => {
                                ...
                                <Form.Row className="align-items-center">
                                    ...
                                    <Col >
                                      <Button className="mb-2 btColor" style={{ float:"right" }} onClick={ () => {
                                          sendMessage( document.getElementById( 'messageData' ).value );
                                          document.getElementById( 'messageData' ).value = "";
                                      }}>
                                        Send
